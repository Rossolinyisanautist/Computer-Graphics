...
//    auto[normal1_data, normal1_width, normal1_height, normal1_channels] = file_utilities::read_image_file("data/images/NormalMap.png");
    auto texture1 = std::make_shared<ES2Texture>(image1_data, image1_width, image1_height, image1_channels);
//    auto normal1 = std::make_shared<ES2Texture>(normal1_data, normal1_width, normal1_height, normal1_channels);
    plane1_material->set_texture_1(texture1);
//    plane1_material->set_normal_1(normal1);
