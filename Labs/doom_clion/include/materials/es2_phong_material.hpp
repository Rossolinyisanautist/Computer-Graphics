    ...
    public:
        ...
        void update(std::shared_ptr<Scene> scene, std::shared_ptr<Mesh> mesh) final
        {
            ...
            if(mesh-> is_billboard()) {
                ...
                glm::vec3 scale = mesh-> get_world_scale();
                glm::mat4 mesh_world_matrix = mesh-> get_world_matrix();

                mesh_world_matrix[0][0] = camera_world_matrix[0][0] * scale[0];
                mesh_world_matrix[1][0] = camera_world_matrix[1][0] * scale[0];
                mesh_world_matrix[2][0] = camera_world_matrix[2][0] * scale[0];
                mesh_world_matrix[0][1] = camera_world_matrix[0][1] * scale[1];
                mesh_world_matrix[1][1] = camera_world_matrix[1][1] * scale[1];
                mesh_world_matrix[2][1] = camera_world_matrix[2][1] * scale[1];
                mesh_world_matrix[0][2] = camera_world_matrix[0][2] * scale[2];
                mesh_world_matrix[1][2] = camera_world_matrix[1][2] * scale[2];
                mesh_world_matrix[2][2] = camera_world_matrix[2][2] * scale[2];
                model_view_matrix = camera-> get_view_matrix() * mesh_world_matrix;
            }
            else {
